...
4. Run the script (use `$CLAUDE_PLUGIN_ROOT` when installed as a plugin; otherwise the local path):
   ```bash
   python3 "$CLAUDE_PLUGIN_ROOT/skills/model-montage/generate.py" \
